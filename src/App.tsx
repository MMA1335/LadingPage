...
const Logo = ({ showText }: { showText: boolean }) => (
  <div className="flex items-center gap-3">
    ...
    >
      <span className="font-display font-black text-xs uppercase tracking-[0.2em] text-white">
        Esquadrão
      </span>
      <span className="font-display font-black text-lg uppercase tracking-[0.1em] text-gold leading-none italic">
        Águia
      </span>
    </motion.div>
  </div>
    ...
    >
      ...
      >
        ...
        <p className="text-white/60 mb-8 leading-relaxed italic">
          "O primeiro passo para o topo é o alistamento silencioso na tropa da
          disciplina. Sua jornada Pro começa agora."
        </p>
        <button
          onClick={onClose}
...
export default function App() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative bg-dark-bg overflow-hidden selection:bg-gold selection:text-black"
    >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="max-w-md text-lg text-white/50 mb-10 leading-relaxed">
                Transformando a mentalidade militar em resultados de elite.
                Junte-se à Tropa e conquiste o físico de um campeão
                profissional.
              </p>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 border-y border-white/5 bg-black/40 backdrop-blur-md h-32">
        {[
          ...
          >
            <span className="text-[10px] text-gold font-black uppercase tracking-widest mb-1">
              {stat.label}
            </span>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-6 text-lg text-white/70 leading-relaxed">
                <p>
                  Breno Freire, o{" "}
                  <span className="text-gold font-bold">Tenente Breno</span>,
                  não apenas treina; ele comanda. Ex-primeiro tenente do
                  Exército Brasileiro, ele trouxe a disciplina férrea das forças
                  armadas para o universo do fisiculturismo.
                </p>
                <div className="grid grid-cols-1 gap-6 pt-6">
                  <div className="military-border p-6 bg-dark-surface/50">
                    <h4 className="text-gold font-bold mb-2 uppercase tracking-tight">
                      Carreira Militar
                    </h4>
                    <p className="text-sm">
                      Campeão de arremesso de peso nas Olimpíadas Militares e
                      destaque físico absoluto em sua tropa.
                    </p>
                  </div>
                  <div className="military-border p-6 bg-dark-surface/50">
                    <h4 className="text-gold font-bold mb-2 uppercase tracking-tight">
                      Nascimento de um Pro
                    </h4>
                    <p className="text-sm">
                      Consagrou-se profissional após vitórias esmagadoras no Mr.
                      Olympia Amador 2023 (Espanha/Portugal).
                    </p>
                  </div>
                </div>
                <p className="italic border-l-2 border-gold pl-6 py-2 mt-8 text-white/90">
                  "Minha missão é mostrar que o shape de elite é construído com
                  10% de genética e 90% de ordem e progresso individual."
                </p>
              </div>
            </div>
            <motion.div
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                <h3 className="text-3xl font-bold mb-2">
                  Pronto para o Alistamento?
                </h3>
                <p className="text-white/50 italic">
                  Vagas limitadas para acompanhamento individual direto com o
                  Tenente.
                </p>
              </div>
              <button
          ...
          <div className="space-y-8">
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h4 className="text-xl font-bold mb-2 uppercase tracking-tight">
                  Encontros do Esquadrão
                </h4>
                <p className="text-white/60">
                  Treinos presenciais exclusivos na Ironberg Fortaleza e em
                  turnês pelo Brasil.
                </p>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-white/60">
                  Acesso a conteúdos exclusivos, estudos de caso e hacks de
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-white/60">
                  Acesso antecipado ao e-book "Tropa Tenente Breno" e materiais
                  de apoio teórico.
                </p>
              </div>
            </div>
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="group cursor-pointer">
                ...
                <h4 className="text-xl font-bold uppercase tracking-tight">
                  Operação Evolução {item}
                </h4>
                <p className="text-white/40 text-sm">
                  Hipertrofia e definição extrema com o método Esquadrão.
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 bg-dark-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs uppercase tracking-[0.5em] text-white/30 font-bold mb-12">
            Aliados Estratégicos
          </p>
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            <div className="flex flex-col items-center gap-4">
              <img
                src="/assets/LogoMaxTitanium.png"
                alt="Max Titanium"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            <div className="md:col-span-2">
              ...
              <p className="mt-8 text-white/50 max-w-sm leading-relaxed">
                Consultoria Fitness de Performance comandada pelo Atleta Pro
                Tenente Breno. Transformação física baseada em ciência e
                disciplina militar.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                <a
                  href="https://instagram.com/tenentebreno"
                ...
                <a
                  href="https://tiktok.com/@tenentebreno"
                  className="flex items-center gap-3 text-sm text-white/40 hover:text-gold transition-colors"
                >
                ...
                <a
                  href="#"
                  className="flex items-center gap-3 text-sm text-gold font-bold"
                >
          ...
          <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-[10px] uppercase tracking-widest text-white/20 font-bold">
              © 2024 Tenente Breno - Consultoria Esquadrão Águia. Todos os
              direitos reservados.
            </p>
